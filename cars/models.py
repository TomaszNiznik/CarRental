...
class Car(models.Model):
    ...
    brand = models.CharField(max_lenght = 50)
    model = models.CharField(max_lenght = 50)
    engine_type= models.CharField(max_lenght=50, choices=Engine_Types)
    gearbox = models.CharField(max_lenght=50, choices =GEARBOX_TYPES)
    ...
    fuel_usage = models.DecimalField
